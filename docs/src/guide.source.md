...
<a id="fig-markdown-example"></a> **FIG:** Markdown example

[[EXAMPLE:fig-markdown-example:md]]
...
<a id="fig-enable-templates-checkboxes"></a> **FIG:** Enabling the module for your templates using the "Enabled Templates" checkboxes
...
<a id="fig-accessing-content-of-this-markdown"></a> **FIG:** Accessing the content of [this markdown](#fig-markdown-example)
...
[[EXAMPLE:fig-accessing-content-of-this-markdown:php]]
...
<a id="fig-markdown-with-two-sections"></a> **FIG:** Markdown with two sections

[[EXAMPLE:fig-markdown-with-two-sections:md]]

<a id="fig-rendering-sections"></a> **FIG:** Rendering sections

[[EXAMPLE:fig-rendering-sections:php]]
...
<a id="fig-content-without-section"></a> **FIG:** Content without a section

[[EXAMPLE:fig-content-without-section:md]]

<a id="fig-rendering-orphan-section"></a> **FIG:** Rendering an orphan section

[[EXAMPLE:fig-rendering-orphan-section:php]]
...
<a id="fig-section-with-tag-field-subsection"></a> **FIG:** Section with a tag field and a subsection

[[EXAMPLE:fig-section-with-tag-field-subsection:md]]

The section object exposes them like this

[[DUMP:fig-section-with-tag-field-subsection]]
...
<a id="fig-content-with-subsections"></a> **FIG:** Content with subsections

[[EXAMPLE:fig-content-with-subsections:md]]

<a id="fig-rendering-html-subsections"></a> **FIG:** Rendering HTML of subsections

[[EXAMPLE:fig-rendering-html-subsections:php]]

Subsections are returned as `Section` objects with the same core properties:

[[REFLECT:Section]]

<a id="fig-section-object-columns-left"></a> **FIG:** Example of section object for `$jane` aka: `$page->content()->columns->left`

[[DUMP:fig-section-object-columns-left]]
...
<a id="fig-content-with-blocks-and-children"></a> **FIG:** Content example with blocks and childs

[[EXAMPLE:fig-content-with-blocks-and-children:md]]
...
<a id="fig-getting-blocks-of-section"></a> **FIG:** Getting the blocks of a section

[[EXAMPLE:fig-getting-blocks-of-section:php]]

Or, you can also access blocks by index:

<a id="fig-getting-section-blocks-by-index"></a> **FIG:** Getting section and blocks by index

[[EXAMPLE:fig-getting-section-blocks-by-index:php]]
...
<a id="fig-block-object-about"></a> **FIG:** Output of Block object `$about` from the markdown in [Content example with blocks and childs](#fig-content-with-blocks-and-children) 


[[DUMP:fig-block-object-about]]
...
<a id="fig-accessing-block-children"></a> **FIG:** Accessing block children and sub-children

[[EXAMPLE:fig-accessing-block-children:php]]
...
<a id="fig-content-with-lists-images-paragraphs-links"></a> **FIG:** Content with lists, images, paragraphs, and links

[[EXAMPLE:fig-content-with-lists-images-paragraphs-links:md]]

Each block object contains a `HeadingElement` and the `ContentElementCollection` for lists, images, paragraphs, and links:

<a id="fig-getting-elements-from-block"></a> **FIG:** Getting elements from a block

[[EXAMPLE:fig-getting-elements-from-block:php]]

You can also drill down to specific elements:

<a id="fig-accessing-specific-elements"></a> **FIG:** Accessing specific elements

[[EXAMPLE:fig-accessing-specific-elements:php]]
...
[[REFLECT:HeadingElement]]



<a id="fig-heading-output"></a> **FIG:** Output of heading $heading from [Digital Studio markdown example](#fig-content-with-lists-images-paragraphs-links)
[[DUMP:fig-heading-output]]
...
<a id="fig-accessing-paragraphs-markdown-example"></a> **FIG:** Accessing paragraphs from the markdown example in [Digital Studio markdown example](#fig-content-with-lists-images-paragraphs-links)

[[EXAMPLE:fig-accessing-paragraphs-markdown-example:php]]

<a id="fig-paragraph-contentelement-example"></a> **FIG:** Paragraph `ContentElement` example

[[DUMP:fig-paragraph-contentelement-example]]
...
<a id="fig-accessing-lists-markdown-example"></a> **FIG:** Accessing lists from the [Digital Studio markdown example](#fig-content-with-lists-images-paragraphs-links)

[[EXAMPLE:fig-accessing-lists-markdown-example:php]]

<a id="fig-list-contentelement-example"></a> **FIG:** List `ContentElement` example

[[DUMP:fig-list-contentelement-example]]
...
<a id="fig-accessing-links-markdown-example"></a> **FIG:** Accessing links from the [Digital Studio markdown example](#fig-content-with-lists-images-paragraphs-links)

[[EXAMPLE:fig-accessing-links-markdown-example:php]]

<a id="fig-link-contentelement-example"></a> **FIG:** Link `ContentElement` example

[[DUMP:fig-link-contentelement-example]]
...
<a id="fig-accessing-images-markdown-example"></a> **FIG:** Accessing images from the [Digital Studio markdown example](#fig-content-with-lists-images-paragraphs-links)

[[EXAMPLE:fig-accessing-images-markdown-example:php]]

<a id="fig-image-contentelement-example"></a> **FIG:** Image `ContentElement` example

[[DUMP:fig-image-contentelement-example]]
...
<a id="fig-content-with-field-tags"></a> **FIG:** Content with field tags
...
<a id="fig-accessing-field-tagged-elements"></a> **FIG:** Accessing field-tagged elements
...
<a id="fig-field-tags-before-paragraphs-list"></a> **FIG:** Field tags before paragraphs and a list
...
<a id="fig-fielddata-offices"></a> **FIG:** FieldData object for the [`offices`](fig-content-with-field-tags) field tag
...
<a id="fig-using-field-containers"></a> **FIG:** Using field containers
...
<a id="fig-accessing-container-content"></a> **FIG:** Accessing container content
...
<a id="fig-frontmatter-field-binder"></a> **FIG:** A value of frontmatter represented in the content using the  field binder
...
<a id="fig-image-with-field-tag"></a> **FIG:** Image with field tag
...
<a id="fig-getting-pageimage-object"></a> **FIG:** Getting the `ProcessWire\Pageimage` object
...
<a id="fig-language-name"></a> **FIG:** Example of language page name
...
<a id="fig-language-code"></a> **FIG:** Code field on language template
...
<a id="fig-language-default-code"></a> **FIG:** Default language code name
